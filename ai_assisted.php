...
<!-- 
        ...
        <div class="container">
            <div class="card custom-card">
                ...
                <div class="card-body">
                            <label >1. The solution generated by AI will compose the variables you specified here, and the value generated will be inside the minimum and maximum values you specified.</label></br>
                            <label >2. You will evaluate the solution generated by AI later based on the objectives you specified.</label></br>
                            <label >3. Every variable is related to <strong>all</strong> objectives together, please <strong>avoid</strong> inputting variables that are only related to a single objectives.
                </div>
            </div>
        </div>
<!-- 
  ...
  Each variable should contribute to multiple objectives, rather than just one. Try to avoid input variables that only help with a single objective
    ...
    <button class="btn btn-outline-primary" id="back-button" style="width: 20%;" onclick="goBack()">Previous</button>
    </div>
