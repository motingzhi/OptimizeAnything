...
log_file_path = os.path.join(log_file_folder, "finish_solutions.log")
...
for i in range(int(len(objectives_list_normalised))):
    ...
    # sub_list2 = [x for sublist in objectives_list_normalised[i:i+len(objectiveNames)] for x in sublist]
    # obj_balance_normalised.append(sub_list2)
    sum = 0
    for n in range(len(objectiveNames)):
