...
<body>
    ...
    <div class="centered-content">
        ...
        <div class="container">
            <br>
            <p>Below is a summary model of your specifications. 
                <!-- <br>You need to confirm your specifications to move to the optimize step. You can refer to bad examples listed below to check your specifications.</p> -->
        ...
        <div class="container">
            ...
            <!-- <div class="card custom-card">
                ...
                <div class="card-body">
                            <label >1. The solution generated by AI will be composed of variables you specified here, and the value generated will be inside the minimum and maximum values you specified.</label></br>
                            <label >
            ...
            <p class="text-primary">Bad examples(Please avoid these 2 types!)</p>
                <div class="card-body">
                            <label >
...
<div class="bottom-bar">
    <div class="row">
            ...
            <button class="btn btn-primary" id="confirm-definitions-button" onclick="confirmDefinitions()" style="width: 30%;">Next</button>
