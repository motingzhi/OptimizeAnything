...
<!-- 
  ...
  Each variable should contribute to multiple objectives, rather than just one. Try to avoid input variables that only help with a single objective
        ...
        <div class="row">
            ...
            <!-- <div class="col text-right" style="margin-right: 20%;">

                <button class="btn btn-outline-primary" id="add-record-button" onclick="addDesignParametersTable()">Ask AI to provide range</button>
            </div>         -->
        </div>       
    ...
    <script>
        ...
        var taskDescription_ai = 'Imagine you have decided to optimize your diet plan. You want to choose an optimal diet that loses weight but stays healthy at the same time, or a diet that meets your other requirements. What kind of variables and objectives would you specify?';
