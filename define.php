...
<body>
            ...
            <div class="card custom-card">
                <div class="card-body">
                    <p class="text-primary"> Hints</p>
                        <label >1. The solution generated by AI will be constructed using the ßß<strong style="color: red;">Variables</strong> defined here, and the value generated will be inside the minimum and maximum values you defined.</label></br>
                        <label >2. Variables are not equal to Objectives.</label></br>
                        <label >3. The objectives are to evaluate the solution generated by AI, which is constructed by variables.</label></br>
                </div>
            </div>
        </div>
    ...
    <div class="bottom-bar">
        <div class="container text-right">
            <button class="btn btn-success" id="finish-objectives-button" style="width: 20%;" onclick="finishObjs()">Define the objectives</button>
        </div>
    </div>
