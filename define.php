            ...
            <div class="card custom-card">
                <div class="card-body">
                    <p class="text-primary"> Hints</p>
                        <label >1. The solution generated by AI will be constructed by <strong style="color: red;">Variables</strong> defined here, and the value generated will be inside the minimum and maximum values you defined.</label></br>
                        <label >2. <strong style="color: red;">Variables</strong> are not equal to <strong style="color: green;">Objectives</strong>.</label></br>
                        <label >3. The <strong style="color: green;">Objectives</strong> are to evaluate the solution generated by AI, which is constructed by <strong style="color: red;">Variables</strong>.</label></br>
                </div>
            </div>
        </div>
