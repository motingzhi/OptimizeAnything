        ...
        <div class="container">
            ...
            <div class="card custom-card">
                ...
                <div class="card-body">
                        ...
                        <label >2. The specification for <strong>Variables</strong> shall not be equal to <strong>Objectives</strong>.</label></br>
                        <label >3. The <strong>Objectives</strong> are the criteria to evaluate the solution generated by AI.</label></br>
                </div>
            </div>
        </div>
