        ...
        <div class="container">
            <div class="card custom-card">
              <p class="text-primary"> Hints</p>
                ...
                <div class="card-body">
                        <div class="description">Optimize: To make 
                            <span class="highlight"><span class="underline objectives">Objectives</span></span> 
                            as 
                            <span class="highlight"><span class="underline normal">high/low</span></span> 
                            as possible for 
                            <span class="highlight"><span class="underline variables">Variables</span></span>
                        </div>
                        <label >1. The solution generated by AI will be constructed by <strong style="color: violet;">Variables</strong> defined here, and the value generated will be inside the minimum and maximum values you defined.</label></br>
                        <label >2. <strong style="color: violet;">Variables</strong> shall not be equal to <strong style="color: orange;">Objectives</strong>.</label></br>
                        <label >3. The <strong style="color: orange;">Objectives</strong> are to evaluate the solution generated by AI, which is constructed by <strong style="color: violet;">Variables</strong>.</label></br>
                </div>
            </div>
        </div>
