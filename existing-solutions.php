...
<body>
    ...
    <script>
        ...
        // for (i = 0; i < paras1.length; i++) {
            paras1.innerHTML = "Parameters";
            paras2.innerHTML =  "Numbers";
        ...
        function addBadSolutionsTable(){
            ...
            // var htmlNewRow = ""
            // htmlNewRow += "<tr>"
            // htmlNewRow += "<td contenteditable='true' class='record-data' id='parameter1'>" + "(" + parameterBounds[2*i] + "-" + parameterBounds[2*i+1]  + ")"+ "</td>"
            // htmlNewRow += "<td contenteditable='true' class='record-data' id='parameter2'>" + "(" + parameterBounds[2*i] + "-" + parameterBounds[2*i+1]  + ")" + "</td>"
            // // htmlNewRow += "<td contenteditable='true' class='record-data' id='parameter3'></td>"
            // htmlNewRow += "<td id='record-data-buttons'>"
            // htmlNewRow += "<button class='record-delete' id='record-delete'><img src='./Pictures/delete.png' style='width: 20px'></button>"
            // htmlNewRow += "</td></tr>"
        ...
        function finishSolutions() {
            ...
            tableBadSols.find('tr').each(function() {
                ...
                console.log("badSolParam1",badSolParam1);
