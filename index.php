...
<body>
    ...
    <div class="container">
        ...
        <h3 class="text-center">First please read the information sheet for participants.</h3><br>
        <h3 class="text-center">You need to read this and agree with the consent form at the <strong>bottom</strong> of the page.</h3><br><br><br>
        ...
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="consent-text">
                    ...
                    <h5 class="text-center">INFORMATION SHEET FOR PARTICIPANTS</h5>
