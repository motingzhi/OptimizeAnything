...
<body>
    ...
    <!-- <form action="tutorial_1.php">
        ...
        <div class="container">
                        ...
                        <!-- <label >Here you can use this service for your own optimization task. Please first describe your optimization task here in your own words.</label></br>                        
                        ...
                        <label >Here, we will assign you a new optimization scenario. You need to convert this scenario to your own optimization task and go through 3 steps to solve the task: Specify, optimize, and get results, same as the tutorial.</label></br>                        
            ...
            <div class="card custom-card">
                <p class="text-primary">Your optimization scenario:</p>
                <div class="card-body">
                    <label id="marathonPlan" style="width:100%;"> 
                    Imagine you have decided to optimize your diet plan. You want to choose an optimal diet that loses weight but stays healthy at the same time (and other requirements if you wish). What kind of variables and objectives would you specify?
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js">
        ...
        // var marathonPlanInput = document.getElementById('marathonPlan');
        //     // 从 local storage 加载数据，如果有的话
        //     marathonPlanInput.innerHTML = "323";
        // if (localStorage.getItem('marathonPlan')) {
        //     marathonPlanInput.innerHTML = localStorage.getItem('marathonPlan');
        // }
        // // 在 textarea 输入内容发生变化时，将内容存储到 local storage
        // marathonPlanInput.addEventListener('input', function() {
