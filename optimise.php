...
<body>
    ...
    <div id="evaluate-solution" style="display: none;">
        ...
        <table id="measurement-table" class="measurement-table" width="100%">
            <thead>  
                <tr>  
                <th id="record-parameter-name" width="40%"> Objective </th>   
                <th id="record-parameter-lower-bound"> Measurement </th>  
                </tr>  
            </thead>  
    ...
    <script>
        ...
        try {var objectivesInput = localStorage.getItem("objectives-input").split(",");}///objectivesInput是什么暂且不用管它，可能它定义了一个多余的数据
        catch(err) {}
...
////用 var = [] 定义一个数组，必须要有[]
        ...
        // console.log("133solutionList",solutionList);
        ...
        // console.log("140generatedSolution",generatedSolution);
        ...
        function newSolution() {
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    console.log(result.train_x_actual);
            ...
            if (noError) {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        console.log(result.cs2);
                        console.log("!!Objectives input");
                        console.log("!!Objectives input",result.objectives);
                        console.log(result.solution);
                        //[Log] !!Objectives input – [[900, 90], [800, 80], [500, 50]] (3) (optimise.php, line 434)
