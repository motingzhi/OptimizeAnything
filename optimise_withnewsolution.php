...
<head>
    ...
    <style>
        ...
        .centered-content {
                ...
                margin-top: calc(100vh / 4); /* Offset by the height of top-bar */
                text-align: center;
...
<!-- 
    ...
    RequirementDisplay.innerHTML =  "Let AI suggest alternatives of solutions with you. Please evaluate at least " + parseInt(2*(parameterNames.length+1)) + " alternatives to proceed." + "<br>" + "Then, after several more evaluations, you will see the Done button, you can choose to continue until you find an optimal solution, or directly finish." + "<br>";
