...
<!-- 
    ...
    RequirementDisplay.innerHTML =  "Let AI suggest alternatives of solutions with you. Please evaluate at least " + parseInt(2*(parameterNames.length+1)) + " alternatives to proceed." + "<br>" + "After you see Done button, you can choose to continue until you find an optimal solution, or directly finish." + "<br>";
