...
<!-- 
    ...
    <div class="container">
        ...
        <div id="form-options-1" style="display: inline-block; margin: 0 auto;">
                <button class="btn btn-primary" id="next-button" onclick="nextEvaluation()">Let AI recommend me the next one</button>
                <button class="btn btn-outline-primary" id="refine-button" onclick="refineSolution()">Explore solutions close to this one</button>
        </div>
