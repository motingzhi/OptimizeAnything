        ...
        if (objectiveNames.length <= 2)
            {
                 ...
                 const x = d3.scaleLinear().domain([objectiveBounds[0]-objectiveBounds[0]*0.01,  objectiveBounds[1]+objectiveBounds[1]*0.01]).range([0, width]);
                 const y = d3.scaleLinear().domain([objectiveBounds[2]-objectiveBounds[2]*0.01,  objectiveBounds[3]+objectiveBounds[3]*0.01]).range([height, 0]);
